<template v-if="!!albumItems">
  <div class="">
    ...
    <div class="lg:flex md:flex">
        ...
        <div class="w-full lg:rounded-2xl md:rounded-2xl p-2 mr-8 sm:overflow-y-scroll xs:overflow-y-scroll sm:albumdetailclass xs:albumdetailclass pb-20" style="background: linear-gradient(15deg, #C56FE1 0%, #CB81F2 50%, #8F41F1 100%)">
